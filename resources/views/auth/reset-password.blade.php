...
<body class="min-h-screen flex items-center justify-center p-4 bg-gray-100">
    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <div class="w-full p-8 bg-white rounded-2xl shadow-lg max-w-lg">
            <h1 class="mb-1 text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl text-center">
                Reset Password Anda
            </h1>
