    ...
    <div id="sidebar" class="fixed left-0 top-0 w-[260px] h-full bg-gray-900 text-white flex flex-col transition-all duration-300 z-50 md:translate-x-0 -translate-x-full">
        ...
        <div class="flex-1 p-4 overflow-y-auto">
            <ul class="space-y-1">
                ...
                <li>
                    <a href="{{route ('riwayat.index')}}" class="flex items-center rounded-lg py-2 px-4 text-white hover:bg-gray-800 hover:text-gray-300 transition-colors group relative">
                ...
                <li>
                    <a href="{{route ('administrasi.index')}}" class="flex items-center rounded-lg py-2 px-4 text-white hover:bg-gray-800 hover:text-gray-300 transition-colors group relative">
                ...
                <li>
                    <a href="{{route ('skp.index')}}" class="flex items-center rounded-lg py-2 px-4 text-white hover:bg-gray-800 hover:text-gray-300 transition-colors group relative">
                ...
                <li class="group">
                    <a href="" class="flex items-center rounded-lg py-2 px-4 text-white hover:bg-gray-800 hover:text-gray-300 group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100 sidebar-dropdown-toggle transition-colors">
                    ...
                    <ul class="sidebar-dropdown pl-7 mt-2 hidden group-[.selected]:block space-y-2">
                        <li>
                            <a href="{{ route('sk.index') }}"
                                class="text-gray-300 text-sm flex items-center hover:text-white transition-colors before:contents-[''] before:w-1 before:h-1 before:rounded-full before:mr-3 
                                {{ request()->routeIs('sk.index') ? 'text-white before:bg-white' : 'before:bg-gray-300' }}">
                                SK GOL III
                            </a>
                        </li>
                        <li>
    ...
    <div id="main-content" class="transition-all duration-300 md:ml-[260px] pt-16 md:pt-0">
        ...
        <div class="p-5 mt-5">
            ...
            <div class="flex justify-between items-center mb-4 max-w-full overflow-x-auto hidden sm:flex">
                <a class="bg-gray-800 rounded-md px-4 py-2 text-base font-medium hover:bg-gray-700 text-white h-10" href="{{route ('sk.create')}}">
                    Tambah
                </a>
                ...
                <table class="w-full ">
                    <thead class="bg-gray-50 border-b-2 border-gray-200">
                        <tr>
                            ...
                            <th class="sticky top-0 bg-gray-50 z-10 w-48 p-3 text-sm font-semibold tracking-wide text-center truncate">SK GOL III A</th>
                            <th class="sticky top-0 bg-gray-50 z-10 w-48 p-3 text-sm font-semibold tracking-wide text-center truncate">SK GOL III B</th>
                            <th class="sticky top-0 bg-gray-50 z-10 w-48 p-3 text-sm font-semibold tracking-wide text-center truncate">SK GOL III C</th>
                            <th class="sticky top-0 bg-gray-50 z-10 w-48 p-3 text-sm font-semibold tracking-wide text-center truncate">SK GOL III D</th>
                    ...
                    <tbody class="divide-y divide-gray-100 ">
                        ...
                        <tr class="{{ $loop->odd ? 'bg-white' : 'bg-gray-50' }}">
                            ...
                            <td class="p-3 text-sm text-gray-700 whitespace-nowrap text-center align-middle relative">
                                @if ($sk->skiii_a)
                                <img src="{{ asset('storage/' . $sk->skiii_a) }}" alt="Kartu" width="100" class="mx-auto">

                                <a href="{{ asset('storage/' . $sk->skiii_a) }}" download
                            ...
                            <td class="p-3 text-sm text-gray-700 whitespace-nowrap text-center align-middle relative">
                                @if ($sk->skiii_b)
                                <img src="{{ asset('storage/' . $sk->skiii_b) }}" alt="Kartu" width="100" class="mx-auto">

                                <a href="{{ asset('storage/' . $sk->skiii_b) }}" download
                                    class="absolute bottom-2 right-2">
                                    <img src="{{ asset('images/download.png') }}" alt="Download" width="20">
                                </a>
                                @else
                            ...
                            <td class="p-3 text-sm text-gray-700 whitespace-nowrap text-center align-middle relative">
                                @if ($sk->skiii_c)
                                <img src="{{ asset('storage/' . $sk->skiii_c) }}" alt="Kartu" width="100" class="mx-auto">

                                <a href="{{ asset('storage/' . $sk->skiii_c) }}" download
                                    class="absolute bottom-2 right-2">
                                    <img src="{{ asset('images/download.png') }}" alt="Download" width="20">
                                </a>
                                @else
                            ...
                            <td class="p-3 text-sm text-gray-700 whitespace-nowrap text-center align-middle relative">
                                @if ($sk->skiii_d)
                                <img src="{{ asset('storage/' . $sk->skiii_d) }}" alt="Kartu" width="100" class="mx-auto">

                                <a href="{{ asset('storage/' . $sk->skiii_d) }}" download
                                    class="absolute bottom-2 right-2">
                                    <img src="{{ asset('images/download.png') }}" alt="Download" width="20">
                                </a>
                                @else
                            ...
                            <td class="p-3 text-sm text-gray-700 whitespace-nowrap">
                                <form action="{{route ('sk.destroy', $sk->id)}}" method="POST" class="flex space-x-2  justify-center">
                                    <a href="{{route ('sk.edit', $sk->id)}}" class="inline-flex items-center justify-center bg-blue-500 rounded-md px-2 py-2 text-[12px] font-medium hover:bg-blue-400 text-white">Edit</a>
                                    @csrf
                                    @method('DELETE')
            ...
            <div class="grid grid-cols-1 gap-4 md:hidden">
                <div class="flex justify-between items-center mb-2 max-w-full overflow-x-auto sm:hidden">
                    ...
                    <form action="" method="GET" class="">
                        <div class="flex w-60 items-center rounded bg-gray-300 px-2 py-1 h-10">
                            <input
                                type="search"
                                name="search"
                                id="search"
                                placeholder="Cari"
                                autocomplete="off"
                                class="w-full border-none bg-transparent px-3 py-2 text-gray-900 outline-none" />
                            <button class="rounded bg-gray-800 px-3 py-1 text-white hover:bg-gray-700 text-sm">
                                Cari
                            </button>
                        </div>
                    </form>
                ...
                <div class="bg-white p-4 space-y-4 rounded-lg shadow mt-0">
                    ...
                    <div class="flex items-center justify-between w-full  text-base">
                        ...
                        <div class="text-sm text-gray-700 text-right">{{$sk->pegawai->nama}}</div>
                    </div>
                    <!-- SK GOL A -->
                    <div class="flex items-center justify-between w-full  text-base">
                        <div class="font-semibold text-gray-400">SK GOL III A</div>
                        <div class="text-sm text-gray-700 text-right">
                            @if ($sk->skiii_a)
                            <div class="flex flex-col items-center space-y-2">
                                <img src="{{ asset('storage/' . $sk->skiii_a) }}" alt="Kartu" class="w-24 h-auto">
                                <a href="{{ asset('storage/' . $sk->skiii_a) }}" download class="inline-flex items-center space-x-1 text-blue-600 hover:underline text-xs">
                    ...
                    <!-- SK GOL B -->
                    <div class="flex items-center justify-between w-full  text-base">
                        <div class="font-semibold text-gray-400">SK GOL III B</div>
                        <div class="text-sm text-gray-700 text-right">
                            @if ($sk->skiii_b)
                            <div class="flex flex-col items-center space-y-2">
                                <img src="{{ asset('storage/' . $sk->skiii_b) }}" alt="Kartu" class="w-24 h-auto">
                                <a href="{{ asset('storage/' . $sk->skiii_b) }}" download class="inline-flex items-center space-x-1 text-blue-600 hover:underline text-xs">
                                    <img src="{{ asset('images/download.png') }}" alt="Download" class="w-4 h-4">
                                    <span>Download</span>
                                </a>
                            </div>
                    ...
                    <!-- SK GOL C -->
                    <div class="flex items-center justify-between w-full  text-base">
                        <div class="font-semibold text-gray-400">SK GOL III C</div>
                        <div class="text-sm text-gray-700 text-right">
                            @if ($sk->skiii_b)
                            <div class="flex flex-col items-center space-y-2">
                                <img src="{{ asset('storage/' . $sk->skiii_c) }}" alt="Kartu" class="w-24 h-auto">
                                <a href="{{ asset('storage/' . $sk->skiii_c) }}" download class="inline-flex items-center space-x-1 text-blue-600 hover:underline text-xs">
                                    <img src="{{ asset('images/download.png') }}" alt="Download" class="w-4 h-4">
                                    <span>Download</span>
                                </a>
                            </div>
                    ...
                    <!-- SK GOL D -->
                    <div class="flex items-center justify-between w-full  text-base">
                        <div class="font-semibold text-gray-400">SK GOL III D</div>
                        <div class="text-sm text-gray-700 text-right">
                            @if ($sk->skiii_d)
                            <div class="flex flex-col items-center space-y-2">
                                <img src="{{ asset('storage/' . $sk->skiii_d) }}" alt="Kartu" class="w-24 h-auto">
                                <a href="{{ asset('storage/' . $sk->skiii_d) }}" download class="inline-flex items-center space-x-1 text-blue-600 hover:underline text-xs">
                                    <img src="{{ asset('images/download.png') }}" alt="Download" class="w-4 h-4">
                                    <span>Download</span>
                                </a>
                            </div>
                    ...
                    <div class="flex items-center justify-center w-full">
                        <form action="{{route('sk.destroy', $sk->id)}}" method="POST" class="flex space-x-2">
                            <a href="{{route('sk.edit', $sk->id)}}" class="inline-flex items-center justify-center bg-blue-500 rounded-md px-2 py-2 text-[12px] font-medium hover:bg-blue-400 text-white">Edit</a>
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="inline-flex items-center justify-center bg-blue-500 rounded-md px-2 py-2 text-[12px] font-medium hover:bg-blue-400 text-white">Hapus</button>
