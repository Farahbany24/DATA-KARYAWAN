        ...
        <table class="w-full ">
          <thead class="bg-gray-50 border-b-2 border-gray-200">
            <tr>
              ...
              <th class="sticky top-0 bg-gray-50 z-10 w-48 p-3 text-sm font-semibold tracking-wide text-center truncate">IJAZAH</th>
              <th class="sticky top-0 bg-gray-50 z-10 w-48 p-3 text-sm font-semibold tracking-wide text-center truncate">GAJI BERKALA</th>
              <th class="sticky top-0 bg-gray-50 z-10 w-48 p-3 text-sm font-semibold tracking-wide text-center truncate">Taspen</th>
          ...
          <tbody class="divide-y divide-gray-100 ">
            ...
            <tr class="{{ $loop->odd ? 'bg-white' : 'bg-gray-50' }}">
              ...
              <td class="p-3 text-sm text-gray-700 whitespace-nowrap text-center">
                {{$administrasi->pegawai->nama}}
              </td>
              <td class="p-3 text-sm text-gray-700 whitespace-nowrap text-center align-middle relative">
                @if ($administrasi->ijazah)
                <img src="{{ asset('storage/' . $administrasi->ijazah) }}" alt="Kartu" width="100" class="mx-auto">
                <a href="{{ asset('storage/' . $administrasi->ijazah) }}" download
              ...
              <td class="p-3 text-sm text-gray-700 whitespace-nowrap text-center align-middle relative">
                ...
                <img src="{{ asset('storage/' . $administrasi->gaji_berkala) }}" alt="Kartu" width="100" class="mx-auto">

                <a href="{{ asset('storage/' . $administrasi->gaji_berkala) }}" download
                  class="absolute bottom-2 right-2">
                  <img src="{{ asset('images/download.png') }}" alt="Download" width="20">
                </a>
                @else
              ...
              <td class="p-3 text-sm text-gray-700 whitespace-nowrap text-center align-middle relative">
                ...
                <img src="{{ asset('storage/' . $administrasi->taspen) }}" alt="Kartu" width="100" class="mx-auto">

                <a href="{{ asset('storage/' . $administrasi->taspen) }}" download
                  class="absolute bottom-2 right-2">
                  <img src="{{ asset('images/download.png') }}" alt="Download" width="20">
                </a>
                @else
              ...
              <td class="p-3 text-sm text-gray-700 whitespace-nowrap">
                <form action="{{route ('administrasi.destroy', $administrasi->id)}}" method="POST" class="flex space-x-2  justify-center">
      ...
      <div class="grid grid-cols-1 gap-4 md:hidden">
        ...
        <div class="bg-white p-4 space-y-4 rounded-lg shadow mt-0">
          ...
          <div class="flex items-center justify-between w-full  text-base">
            ...
            <div class="text-sm text-gray-700 text-right">{{$administrasi->pegawai->nama}}</div>
          </div>
          <!-- IJAZAH -->
          <div class="flex items-center justify-between w-full  text-base">
            <div class="font-semibold text-gray-400">IJAZAH</div>
            <div class="text-sm text-gray-700 text-right">
              @if ($administrasi->ijazah)
              <div class="flex flex-col items-center space-y-2">
                <img src="{{ asset('storage/' . $administrasi->ijazah) }}" alt="Kartu" class="w-24 h-auto">
                <a href="{{ asset('storage/' . $administrasi->ijazah) }}" download class="inline-flex items-center space-x-1 text-blue-600 hover:underline text-xs">
          ...
          <!-- GAJI BERKALA -->
          <div class="flex items-center justify-between w-full  text-base">
            <div class="font-semibold text-gray-400">GAJI BERKALA</div>
            <div class="text-sm text-gray-700 text-right">
              @if ($administrasi->gaji_berkala)
              <div class="flex flex-col items-center space-y-2">
                <img src="{{ asset('storage/' . $administrasi->gaji_berkala) }}" alt="Kartu" class="w-24 h-auto">
                <a href="{{ asset('storage/' . $administrasi->gaji_berkala) }}" download class="inline-flex items-center space-x-1 text-blue-600 hover:underline text-xs">
                  <img src="{{ asset('images/download.png') }}" alt="Download" class="w-4 h-4">
                  <span>Download</span>
                </a>
              </div>
          ...
          <!-- TASPEN -->
          <div class="flex items-center justify-between w-full  text-base">
            <div class="font-semibold text-gray-400">TASPEN</div>
            <div class="text-sm text-gray-700 text-right">
              @if ($administrasi->taspen)
              <div class="flex flex-col items-center space-y-2">
                <img src="{{ asset('storage/' . $administrasi->taspen) }}" alt="Kartu" class="w-24 h-auto">
                <a href="{{ asset('storage/' . $administrasi->taspen) }}" download class="inline-flex items-center space-x-1 text-blue-600 hover:underline text-xs">
                  <img src="{{ asset('images/download.png') }}" alt="Download" class="w-4 h-4">
                  <span>Download</span>
                </a>
              </div>
          ...
          <div class="flex items-center justify-center w-full">
            <form action="{{route('administrasi.destroy', $administrasi->id)}}" method="POST" class="flex space-x-2">
              <a href="{{route('administrasi.edit', $administrasi->id)}}" class="inline-flex items-center justify-center bg-blue-500 rounded-md px-2 py-2 text-[12px] font-medium hover:bg-blue-400 text-white">Edit</a>
              @csrf
              @method('DELETE')
              <button type="submit" class="inline-flex items-center justify-center bg-blue-500 rounded-md px-2 py-2 text-[12px] font-medium hover:bg-blue-400 text-white">Hapus</button>
