                ...
                <form action="{{route('pegawai.update', $pegawai->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <div class="flex items-center rounded-md bg-white pl-3 outline outline-1 outline-gray-300 focus-within:outline-2 focus-within:outline-indigo-600">
                                    <input type="text" name="pangkat_gol" id="pangkat" value="{{$pegawai->pangkat_gol}}"
                                        class="block w-full py-1.5 pl-1 pr-3 text-gray-900 placeholder-gray-400 focus:outline-none text-sm"
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                                <div class="text-center">
                                    @if ($pegawai->karpeg)
                                    <img src="{{ asset('storage/' . $pegawai->karpeg) }}" alt="karpeg_lama"
                                    ...
                                    @endif
                                    <input type="hidden" name="karpeg_lama" value="{{$pegawai->karpeg}}">
                                    <div class="mt-4 flex text-sm text-gray-600">
                                        <label for="karpeg-upload"
                                            class="relative cursor-pointer rounded-md bg-white font-semibold text-indigo-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-indigo-500">
                                            <span>Upload a file</span>
                                            <input id="karpeg-upload" name="karpeg" type="file"
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                                <div class="text-center">
                                    ...
                                    <img src="{{ asset('storage/' . $pegawai->karis_karsu) }}" alt="karis_karsu_lama"
                                        class="mx-auto w-auto h-40">
                                    @else
                                    <svg class="mx-auto size-12 text-gray-300" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                                        <path fill-rule="evenodd" d="M1.5 6a2.25 2.25 0 0 1 2.25-2.25h16.5A2.25 2.25 0 0 1 22.5 6v12a2.25 2.25 0 0 1-2.25 2.25H3.75A2.25 2.25 0 0 1 1.5 18V6ZM3 16.06V18c0 .414.336.75.75.75h16.5A.75.75 0 0 0 21 18v-1.94l-2.69-2.689a1.5 1.5 0 0 0-2.12 0l-.88.879.97.97a.75.75 0 1 1-1.06 1.06l-5.16-5.159a1.5 1.5 0 0 0-2.12 0L3 16.061Zm10.125-7.81a1.125 1.125 0 1 1 2.25 0 1.125 1.125 0 0 1-2.25 0Z" clip-rule="evenodd" />
                                    ...
                                    @endif
                                    <input type="hidden" name="karis_karsu_lama" value="{{$pegawai->karis_karsu}}">
                                    <div class="mt-4 flex text-sm text-gray-600">
                                        <label for="karis-karsu-upload"
                                            class="relative cursor-pointer rounded-md bg-white font-semibold text-indigo-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-indigo-500">
                                            <span>Upload a file</span>
                                            <input id="karis-karsu-upload" name="karis_karsu" type="file"
                                                class="sr-only" accept="image/*" />
                                        </label>
                                        <p class="pl-1">or drag and drop</p>
                                    </div>
